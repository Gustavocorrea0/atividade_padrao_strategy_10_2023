...
public class MeioPagamentoCieloEstrategia implements MeioPagamentoEstrategia {
    ...
    public void pagar(Double valor) {
        System.out.printf("Pagamento via Cielo no valor," + valor + ", realizado com sucesso");
    }
            ...
            if (validarCartao(numeroCartao)) {
                if (validarCVV(cvv)) {
                    if (validarDataValidade(dataValidade)) {
                        System.out.println("Todos os dados do cartão de credito são validos");
    ...
    public void validarDadosDebito() {
        if (validarCPF(cpf)) {
            if (validarCartao(numeroCartao)) {
                if (validarCVV(cvv)) {
                    if (validarDataValidade(dataValidade)) {
                        System.out.println("Todos os dados do cartão de debito são validos");
